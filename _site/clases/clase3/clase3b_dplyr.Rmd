...
Para hacer la prueba pueden crear un `.rmd` nuevo o usar una plantilla:

```{r echo=FALSE}
xfun::embed_file("tarea2/tarea2_dplyr_formato.rmd", text = "Descargar plantilla de tarea 2")
```
