...
description: "Por Kevin Carrasco, ayudante del curso."
---

```{r echo=FALSE}
xfun::embed_file("practicas/ejerciciopractico1.Rmd", text = "Descargar como archivo .rmd")
```

```{r echo=FALSE}
xfun::embed_file("practicas/ejerciciopractico1.html", text = "Descargar como archivo .html")
```
