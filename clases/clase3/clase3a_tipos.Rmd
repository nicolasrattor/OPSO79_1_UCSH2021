...
+ producido para otros fines, pero nosotros/as lo usemos para los fines propios (**secundarios**). 
...
Unidades de análisis: *El qué o quién está siendo estudiado. En la investigación en ciencias sociales, las unidades de análisis más típicas son las personas individuales (...) Es importante distinguir entre la unidad de análisis y los agregados sobre los que generalizamos.* `r Citet(bib, "Babbie2014")`.
...
+ nivel de medida de sus variables (solo en caso de datos ordenados)
