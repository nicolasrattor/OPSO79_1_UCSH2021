...
+ corrección de ortografía (spell check)

+ gestión bibliográfica (taller Zotero)
...
```{r echo=FALSE}
xfun::embed_file("formato_ucsh.Rmd", text = "Descargar formato pdf")
```
...
# Herramientas de gestión bibliográfica y R

[Presentación opcional, si alcanzamos en el bloque de clases](https://opso791ucsh2021.netlify.app/clases/clase10/clase10c_zotero_bibtex) 
