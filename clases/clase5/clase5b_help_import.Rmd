...
```{r echo=FALSE}
xfun::embed_file("data/ene_de_muestra.sav", text = "descarga muestra ene-2021-06-mjj.rds")
```
...
Primero veamos cuáles son los valores de sexo
...
+ ¿Cuantas personas `pet` y `to` hay en la muestra? 
