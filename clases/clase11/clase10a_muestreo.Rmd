...
Se considra la varianza de una pregunta de investigación previa. A mayor varianza, más casos se necesitarán. Si no hay información se supone varianza máxima (`r 0.5^2`)
...
Agrupar en grupos homogéneos, aumenta la precisión de la estimación. Con esto, se puede asegurar precisión para cada estrato. 
